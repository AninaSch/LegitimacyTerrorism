...
xtnbreg n_events lag1fh_ppp lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable i.year , fe irr 
xtnbreg n_events lag1fh_fog lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable i.year , fe irr 
...
*--------------  WORLD VALUE SURVEY
xthybrid n_events lag1wvs_trust lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable i.year   , fe irr 
