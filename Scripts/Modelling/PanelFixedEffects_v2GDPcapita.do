...
*ACCOUNTABILITY 
xtnbreg n_events lag1accountability lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
est store model1
* n_domperp_events
xtnbreg n_domperp_events lag1accountability lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
* n_domtarg_events
xtnbreg n_domtarg_events lag1accountability lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
est store model1dom

*CORRUPTION 
xtnbreg n_events lag1corruption lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
est store model2
* n_domperp_events
xtnbreg n_domperp_events lag1corruption lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
* n_domtarg_events
xtnbreg n_domtarg_events lag1corruption lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
est store model2dom

*EFFECTIVENESS 
xtnbreg n_events lag1effectiveness lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
est store model3
* n_domperp_events
xtnbreg n_domperp_events lag1effectiveness lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
* n_domtarg_events
xtnbreg n_domtarg_events lag1effectiveness lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
est store model3dom
...
*QUALITY 
xtnbreg n_events lag1quality lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
est store model4
* n_domperp_events
xtnbreg n_domperp_events lag1quality lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
* n_domtarg_events
xtnbreg n_domtarg_events lag1quality lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
est store model4dom

*RULE OF LAW
xtnbreg n_events lag1rule_of_law lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
est store model5
* n_domperp_events
xtnbreg n_domperp_events lag1rule_of_law lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
* n_domtarg_events
xtnbreg n_domtarg_events lag1rule_of_law lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
est store model5dom
		   
*POLITY IV: polity2
xtnbreg n_events lag1polity2 lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
est store model6
* n_domtarg_events
xtnbreg n_domtarg
xtnbreg n_events lag1polity2 lag1logGDPexp_capita lag1logpop lag1any_conflict lag1durable, fe irr
